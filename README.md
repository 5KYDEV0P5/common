...
| `yum_libraries_utilities` | ntp, lsof, wget, dkms,<br> kernel-devel,<br> kernel-tools,<br> iptables-services,<br> policycoreutils-python,<br> zip,<br> unzip,<br> build-essentials | Install the list of packages needed for RedHat family VM's |
